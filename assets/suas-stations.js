...
function productFigure(kind) {
  if (kind === 'self-rollon') return '<i class="product-figure rollon-figure"><b></b><em></em></i>';
  if (kind === 'self-oil' || kind === 'guided-oil') return '<i class="product-figure oil-figure"><b></b><em></em></i>';
  if (kind === 'guided-butter') return '<i class="product-figure jar-figure"><b></b><em></em></i>';
  if (kind === 'guided-collection') return '<i class="product-figure collection-figure"><b></b><em></em><span></span></i>';
  return '<i class="product-figure perfume-figure"><b></b><em></em></i>';
}
